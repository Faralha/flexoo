...
export default function Home() {
  return (
    <main className="min-h-[50vh] pb-16">
      <section className="bg-berkeley-blue min-h-[75vh] rounded-[28px] gap-24 flex lg:flex-row flex-col items-center justify-between px-[60px]">
      ...
      <section className="py-16">
        ...
        <div className="grid grid-cols-3 gap-5 mt-24">
          {[1, 2, 3, 4, 5, 6].map((data, i) => 
            ...
            >
              <div className="bg-gold-primary w-min p-4 text-[38px] text-black-primary">
