...
export default function HeroSection() {
    return (
        <section className="bg-berkeley-blue min-h-[75vh] rounded-[15px] lg:rounded-[28px] gap-24 flex lg:flex-row flex-col items-center justify-between px-[30px] xl:px-[60px] py-[46px]">
